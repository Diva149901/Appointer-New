        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                <tr >
                    ...
                    <td colspan="2">
                        <a href="?action=add&id=none&error=0" class="non-style-link"><button  class="login-btn btn-primary btn button-icon"  style="display: flex;justify-content: center;align-items: center;margin-left:45px;background-image: url('../img/icons/add.svg');">Add New</font></button>
                            </a>
                    </td>
                </tr>
                ...
                <?php
                    if($_POST){
                        ...
                        $sqlmain= "select * from tbl_doctor where docemail='$keyword' or docname='$keyword' or 
                        docname like '$keyword%' or docname like '%$keyword' or docname like '%$keyword%'";
                    }else{
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <select name="spec" id="" class="box" >';
                                        ...
                                        $list11 = $database->query("select  * from  tbl_specialties order by sname asc;");
